...
class ProgArgs
{
    public:
        ...
        /// @brief get the initial placement file file name
        /// @return the initial placement file file name
        const std::string initPlacementFile() const { Assert(this->initPlacementFileIsSet()); return _initPlacementFile; }
        /// @brief determine whether the initial placement file is set
        /// @return whether initial placement file is set
        bool initPlacementFileIsSet() const { return _initPlacementFile != ""; }
        ...
        /// @brief set the initial placement file
        /// @param the initial placement file file name
        void setInitPlacementFile(const std::string &initPlacementFile) { _initPlacementFile = initPlacementFile; }
    private:
        ...
        std::string _initPlacementFile = ""; ///< The initial placement file
