...
CommandLineOptions::CommandLineOptions(int argc, char** argv)
{
    ...
    _parser.add <std::string> ("initplacement", '\0', "initial placement file (cellName xLoc yLoc)", false);
...
void CommandLineOptions::populateAndCheckOptions()
{
    ...
    initPlacementFile = _parser.get<std::string>("initplacement");
...
namespace ProgArgsDetails
{
	...
	progArgs.setInitPlacementFile(opt.initPlacementFile);
