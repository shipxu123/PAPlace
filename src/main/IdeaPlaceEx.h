...
class IdeaPlaceEx
{
    public:
        ...
        // explicit IdeaPlaceEx() = { py::scoped_interpreter guard{}; }
        // explicit IdeaPlaceEx() { py::scoped_interpreter guard{}; }
        ...
        // LocType solveWithParams(LocType gridSize, std::vector<float>& obj_params);
        LocType solveWithParams(LocType gridStep, std::vector<float>& obj_params, PAPlace& pap);
        ...
        /// @brief read initial placement file and set cell coordinates
        /// @param the filename for the initial placement file (format: cellName xLoc yLoc per line)
        void readInitPlacementFile(const std::string &initPlacementFile);
        /*------------------------------*/ 
        /* paramters                    */
        /*------------------------------*/ 
    ...
    // protected:
        ...
        std::string _initPlacementFile = ""; ///< The initial placement file name
};
