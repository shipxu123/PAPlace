...
class NlpGPlacerBase
{
    ...
    public:
        ...
        // explicit NlpGPlacerBase(Database &db, PAPlace &pap) : _db(db), _pap(pap) {}
        IntType solve();
        IntType solveWithParams(std::vector<float>& obj_params);

        void setPAPlacer(PAPlace &pap) { this->_pap = &pap;};
        void guidePlace();
    ...
    protected:
        ...
        void initPlace();
        void initOperators();
        void initOperatorsWithParams(std::vector<float>& obj_params);
    ...
    protected:
        ...
        PAPlace  *_pap; ///< The performace-driven analog engine

        // Database &_papdb; ///< The Performance Aplacement engine database
