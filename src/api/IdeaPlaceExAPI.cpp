...
void initIdeaPlaceExAPI(py::module &m)
{
    py::class_<PROJECT_NAMESPACE::IdeaPlaceEx>(m , "IdeaPlaceEx")
        ...
        .def("solveWithParams", &PROJECT_NAMESPACE::IdeaPlaceEx::solveWithParams, "Solve the problem with Params")
        ...
        .def("readInitPlacementFile", &PROJECT_NAMESPACE::IdeaPlaceEx::readInitPlacementFile, "Read initial placement file and set cell coordinates (format: cellName xLoc yLoc per line)")
        ...
        .def("testPY", &PROJECT_NAMESPACE::IdeaPlaceEx::testPY, "Test PY interpreter")
        ;

    py::class_<PROJECT_NAMESPACE::PAPlace>(m , "PAPlace")
        .def(py::init<>())
        .def("setIdeaPlaceEX", &PROJECT_NAMESPACE::PAPlace::setIdeaPlaceEX, "set IdeaPlaceEX object")
        .def_property("placer", &PROJECT_NAMESPACE::PAPlace::getIdeaPlaceEX, &PROJECT_NAMESPACE::PAPlace::setIdeaPlaceEX, "Define property of Internal Placer")
        .def("getGuideGradient", &PROJECT_NAMESPACE::PAPlace::getGuideGradient, py::return_value_policy::reference_internal, "get Guided Gradient for placement")
        ;

    py::class_<PROJECT_NAMESPACE::PAPlaceData>(m , "PAPlaceData")
        .def(py::init<>())
        .def("setValue", &PROJECT_NAMESPACE::PAPlaceData::setValue, "set value from internal vector")
        .def("getValue", &PROJECT_NAMESPACE::PAPlaceData::getValue, "get value from internal vector")
        .def("getName", &PROJECT_NAMESPACE::PAPlaceData::getName,  "get name from internal names")
        .def_property("size", &PROJECT_NAMESPACE::PAPlaceData::size, &PROJECT_NAMESPACE::PAPlaceData::resize, "Getter and Setter for size of internal vector")
        .def_property("numCells", &PROJECT_NAMESPACE::PAPlaceData::getNumCells, &PROJECT_NAMESPACE::PAPlaceData::setNumCells, "Getter and Setter for numCells of internal vector")
        ;
}
